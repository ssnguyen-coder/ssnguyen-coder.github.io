...
export const MAPLE_DROPPABLE_ITEMS: MapleItem[] = [
  ...
  {
    id: 'maple-cake-relic', name: 'Maple Cake Relic', type: 'Use', icon: 'book.png', color: '#f59e0b', rarity: 'Common',
    reqLevel: 1, reqJob: 'Adventurer', categoryName: 'Temporary Loot', stats: { 'Effect': 'Restores focus' },
    description: 'A cheerful cake discovered beneath the Henesys trees. Its recipe is still a mystery.',
    realWorldImpact: 'A placeholder portfolio drop reserved for a future project highlight.', flavorText: 'Sweet, mysterious, and probably safe to eat.',
  },
  {
    id: 'mushroom-token', name: 'Mushroom Token', type: 'Etc', icon: 'cake.png', color: '#ef4444', rarity: 'Common',
    reqLevel: 1, reqJob: 'Adventurer', categoryName: 'Temporary Loot', stats: { 'Effect': 'Adds +1 curiosity' },
    description: 'A tiny token stamped with an orange mushroom. It seems to point toward another story.',
    realWorldImpact: 'A placeholder portfolio drop reserved for a future project highlight.', flavorText: 'The mushroom definitely knows something.',
  },
  {
    id: 'meso-coin', name: 'Meso Coin', type: 'Etc', icon: 'mushroom.png', color: '#fbbf24', rarity: 'Common',
    reqLevel: 1, reqJob: 'Adventurer', categoryName: 'Temporary Loot', stats: { 'Effect': 'Shines brightly' },
    description: 'A polished coin found on the hunting ground. It catches the light when you move.',
    realWorldImpact: 'A placeholder portfolio drop reserved for a future project highlight.', flavorText: 'Every adventure starts with one small pickup.',
  },
  {
    id: 'maple-letter', name: 'Maple Letter', type: 'Setup', icon: 'coin.png', color: '#60a5fa', rarity: 'Common',
    reqLevel: 1, reqJob: 'Adventurer', categoryName: 'Temporary Loot', stats: { 'Effect': 'Reveals a clue' },
    description: 'A sealed letter waiting for the right portfolio chapter to be written.',
    realWorldImpact: 'A placeholder portfolio drop reserved for a future project highlight.', flavorText: 'Some stories are still being written.',
  },
];
